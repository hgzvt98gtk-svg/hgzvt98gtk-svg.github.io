...
The CSP intentionally allows `https://challenges.cloudflare.com` scripts and frames for Cloudflare Turnstile or challenge flows, and avoids hard-coded nonces because the site is static and does not generate per-request nonce values.
